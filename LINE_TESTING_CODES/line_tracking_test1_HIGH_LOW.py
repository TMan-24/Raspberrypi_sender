...
# Set a PWM signal of 1000 for both motors
    ...
    while TRUE:
        ...
        elif (gpio.input(R_SENSOR) == gpio.LOW and gpio.input(RM_SENSOR) == gpio.LOW) or (gpio.input(L_SENSOR) == gpio.LOW and gpio.input(LM_SENSOR) == gpio.LOW and gpio.input(RM_SENSOR)):
